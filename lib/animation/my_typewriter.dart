...
class MyTypewriterAnimatedText extends AnimatedText {
      ...
      text: TextSpan(
        children: [
          ...
          TextSpan(
            text: cursor,
            style:
                showCursor ? textStyle : const TextStyle(color: Colors.transparent),
          )
        ],
      ),
      textAlign: textAlign,
...
///
/// ![Typewriter example](https://raw.githubusercontent.com/aagarwal1012/Animated-Text-Kit/master/display/typewriter.gif)
@Deprecated('Use AnimatedTextKit with MyTypewriterAnimatedText instead.')
class MyTypewriterAnimatedTextKit extends AnimatedTextKit {
